# Frontend Mentor - Página inicial do Huddle com seções curvas

![Cabeçalho/seção de introdução da página de destino do Huddle com seções curvas](./design/desktop-preview.jpg)
